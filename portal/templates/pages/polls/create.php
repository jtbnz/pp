 ...
 * Create Poll
 *
 * Form to create a new poll (available to all authenticated users).
 */
...
<div class="page-create-poll">
    ...
    <div class="card">
        <form method="POST" action="<?= url('/polls') ?>" class="form" id="poll-form">
            ...
            <div class="form-actions">
                ...
                <a href="<?= url('/polls') ?>" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>

    <div class="nav-back mt-4">
        <a href="<?= url('/polls') ?>" class="btn btn-text">&larr; Back to Polls</a>
    </div>
</div>
